 ...
 * Use the {@link RechnerFragment#newInstance} factory method to
...
public class RechnerFragment extends Fragment {
    ...
    public static RechnerFragment newInstance(String param1, String param2) {
        RechnerFragment fragment = new RechnerFragment();
