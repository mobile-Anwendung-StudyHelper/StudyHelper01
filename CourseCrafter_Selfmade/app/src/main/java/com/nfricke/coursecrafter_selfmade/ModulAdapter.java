...
public class ModulAdapter extends ArrayAdapter<Modul>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        textView12.setText(currentModulPosition.getBlockIntString(0));
        ...
        textView22.setText(currentModulPosition.getBlockIntString(1));
        ...
        textView32.setText(currentModulPosition.getBlockIntString(2));
